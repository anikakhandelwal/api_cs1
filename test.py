...
standard_price = pickle.load(open(datafiles+"price_standardizer.pkl","rb"))
standard_freight = pickle.load(open(datafiles+"freight_value_standardizer.pkl","rb"))
standard_payment= pickle.load(open(datafiles+"payment_value_standardizer.pkl","rb"))
standard_shipping = pickle.load(open(datafiles+"shipping_days_standardizer.pkl","rb"))
standard_length = pickle.load(open(datafiles+"review_length_standardizer.pkl","rb"))
le = pickle.load(open(datafiles+"seller_zip_code_prefix_le.pkl","rb"))
clf = pickle.load(open("/media/anika/DATA/Documents/Python_Scripts/Self_Case_Study/CS1/preprocess_files/xgb_stan.pkl","rb"))
w2v_model = pickle.load(open("/media/anika/DATA/Documents/Python_Scripts/Self_Case_Study/CS1/preprocess_files/self_trained_w2v.pkl","rb"))
